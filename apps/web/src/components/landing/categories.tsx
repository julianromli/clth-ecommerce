...
export default function Categories() {
  return (
    <section id="collections" className="w-full bg-white px-6 py-16 text-center md:px-12 md:py-24">
      ...
      <h2 className="font-heading mb-16 text-3xl font-semibold text-gray-900 md:text-[40px]">
        Explore our collections
      </h2>

      <div className="mx-auto grid max-w-[1200px] grid-cols-2 gap-8 md:gap-12 lg:grid-cols-4">
        {categories.map((category) => (
          <a key={category.title} href="#shop" className="group flex flex-col items-center">
